...
# featured: true
draft: false
tags: [project, showcase, GhostCMS, Front_End_Development, UX_Design, UX]
summary: Coded an indie publication's website using Ghost CMS.
...
![Final Arc website displayed on multiple devices.](../assets/indie-website/finalarc_cover.png)
...
<!-- ![Close-up portrait of a devilishly handsome Korean man.](../assets/indie-website/me.jpg) -->
...
![Udesley's web page for their Ghost CMS and Webflow integration product.](../assets/indie-website/udesly.png)
...
![Unfinished draft of the Porto theme for Ghost CMS.](../assets/indie-website/devenv.png)
...
![Samples of the old Megazoid and new Young Serif fonts.](../assets/indie-website/fonts.png)
...
![Comparison between original and current post card layouts on mobile view.](../assets/indie-website/postcards.png)
...
![Hovering over the mascots in the hero and header sections make them dance!](../assets/indie-website/finalarc_hover.gif)
...
![Numbers for Final Arc's traffic over 3 months since its launch.](../assets/indie-website/traffic.png)
...
![Numbers for how many people looked up Final Arc on a search engine over 3 months since its launch.](../assets/indie-website/organic.png)
